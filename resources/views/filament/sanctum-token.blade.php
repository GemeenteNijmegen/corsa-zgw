  ...
  <div class="rounded-md bg-yellow-50 p-4">
    <div class="flex">
      ...
      <div class="ml-3 block w-full">
        <h3 class="text-sm font-medium text-yellow-800">{{ trans('Let op!') }}</h3>
        <div class="mt-2 text-sm text-yellow-700">
          <p class="mb-4">{{ trans('Je ziet deze token eenmalig, vergeet niet om hem te kopieren en zelf op te slaan!') }}</p>
